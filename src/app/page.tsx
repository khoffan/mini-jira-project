      ...
      <section id="features" className="bg-slate-50 py-24">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-500">จัดการข้อมูลส่วนตัวและซิงค์ข้อมูลผ่าน Firebase Auth ที่มีความปลอดภัยสูง</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-xl font-bold text-slate-900">Prisma & MongoDB</h3>
            <p className="text-slate-500">เก็บข้อมูลอย่างแม่นยำด้วย Prisma ORM และ MongoDB Database รันเร็วบน Local และ Cloud</p>
          </div>
        </div>
      </section>
    </div>
